...
?>
  ...
  <head>
    <meta charset="utf-8">
    <title>Bardis || Administrador-Whisky's</title>
    <link rel="stylesheet" href="../css/categoriawhisky.css">
    ...
    <div id="container">
      ...
      <div class="tabla-producto">
        ...
        <table>
           ...
           * C04 que es la categoria de whisky
           */
          $producto = mysqli_query($conexion, "SELECT * FROM tbl_producto where `id_categoria`='C04'");
