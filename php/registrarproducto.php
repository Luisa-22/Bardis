...
`precio_producto`,`stock_producto`,`descripcion_producto`,`id_categoria`,`cedula_administrador`) 
VALUES('$nombreProducto', '$precioProducto', 
$cantidadProducto,'$descripcionProducto','$categoriaProducto','$ced_admin')") or die (mysqli_error($conexion));
