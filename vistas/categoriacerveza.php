...
?>
  ...
  <head>
    <meta charset="utf-8">
    <title>Bardis || Administrador-Cervezas</title>
    <link rel="stylesheet" href="../css/categoriacerveza.css">
  ...
  <body>
    <div id="container">
      ...
      <div id="categoria-cerveza" onclick="quitarsubmenu()">
        <div id="cate-cerveza">
          <div class="tabla-producto">
            ...
            <table>
              ...
              * 
              * Se realiza la consulta '$producto' a la tabla producto para que me muestre toda la información 
              * de los productos que hay asociados a una categoria en específica, en este caso a las categoria 
              * C02 que es la categoria de cervezas
              */
              $producto = mysqli_query($conexion, "SELECT * FROM tbl_producto where `id_categoria`='C02'");
    ...
    <script src="../js/categoriacerveza.js"></script>
  </body>
