...
?>
  ...
  <head>
    <meta charset="utf-8">
    <title>Bardis || Administrador-Rones</title>
    <link rel="stylesheet" href="../css/categoriarones.css">
    ...
    <div id="container">
      ...
      <div class="tabla-producto">
        ...
        <table>
           ...
           * C03 que es la categoria de rones
           */
          $producto = mysqli_query($conexion, "SELECT * FROM tbl_producto where `id_categoria`='C03'");
