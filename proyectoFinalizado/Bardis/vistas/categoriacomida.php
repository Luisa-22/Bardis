...
?>
  ...
  <head>
    <meta charset="utf-8">
    <title>Bardis || Administrador-Comidas</title>
    <link rel="stylesheet" href="../css/categoriacomida.css">
  ...
  <body>
    <div id="container">
      ...
      <div id="div-pedi">
        ...
        <table>
           ...
           * C01 que es la categoria de comida
           */
          $producto = mysqli_query($conexion, "SELECT * FROM tbl_producto where `id_categoria`='C01'");
    ...
    <script type="text/javascript" src="../js/categoriacomida.js">
